...
<head>
<meta charset="utf-8">
<title>Food Map — Ẩm thực Hà Nội</title>
...
<div id="wrap">
  <aside id="sidebar">
    <h1>Food Map — Hồn phố cổ Hà Nội</h1>
    <p class="lead">Click 1 món để xem vị trí, video review và câu chuyện ngắn.</p>
    <input type="text" id="search" placeholder="Tìm món ăn...">
